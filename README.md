...
## Изменения в символах

В проекте были изменены символы в массиве SYMBOLS:
- ♦ (бубны) → 😊 (смайлик)
- ♣ (трефы) → 👋 (ладошка)
- ♠ (пики) → 🗡️ (шпага)

Теперь все символы на игровой доске берутся из файла config.py, что позволяет легко изменять их в одном месте.
